...
public:
    ...
    inline void LoadPreset(uint8_t idx) {
        ...
        //                            ÷10                           ÷10                                                              ÷10
            ...
            { 1,  60,   0,   1,   800,  175,  0,   0,     3, 6,  120,  -5,    0,  50,  5,   150,     1,   5,  20,    0, 300,  0,  1200, 707}, // 1: Marimba       Dkay 15→120(1.2s); MlltStif 400→175(soft yarn mallet)
            { 2,  36,   0,   1,   100,   50,  0,   0,     3, 5,  105, -10,    0,  50, 15,    10,     1,   5, 150,    0, 300,  0,   100, 707}, // 2: 808 Sub        Dkay 80→105(920ms)
            { 3,  38,   0,   1,   400,  300,  0,   0,     3, 5,   15,  15,    0,  20,  8,   500,    15,   5,  50,  800, 500,  2,   800, 707}, // 3: Ac Snare
            { 4,  72,   0,   1,   900,  500,  0,   0,     3, 7,  150,  30,    0,  10, 20,  1900,    20,   5,   0,    0, 300,  0,  1500, 707}, // 4: Tubular Bell   Model 8→7(OpenTube; open-ended cylinder)
            { 5,  40,   0,   1,   300,   50,  0,   0,     3, 3,  145,  -5,    0,  30, 15,    20,     1,   5,  30,    0, 300,  0,   500, 707}, // 5: Timpani        Dkay 60→145(2.3s)
            { 6,  48,   0,   1,   600,  200,  0,   0,     3, 5,   80,   5,    0,  10, 12,    50,     5,   5,  50,   50, 200,  0,   600, 707}, // 6: Djambe         Dkay 30→80(416ms)
            { 7,  36,   0,   1,   200,   80,  0,   0,     3, 5,  100, -10,    0,  50, 18,    10,     1,   5, 200,    0, 300,  0,   400, 707}, // 7: Taiko          Dkay 70→100(707ms)
            ...
            {10,  72,   0,   1,   600,  280,  0,   0,     3, 0,  130,  10,    0,  80, 12,     0,     1,   5,   0,    0, 300,  0,  1000, 707}, // 10: Koto          Dkay 80→130(1.5s); MlltStif 450→280(finger pluck)
            ...
            {13,  45,   0,   1,   400,  200,  0,   0,     3, 5,   80,  -2,    0,  50, 10,    30,     1,   5,  40,   20, 300,  0,   800, 707}, // 13: Acoustic Tom  Dkay 40→80(416ms)
            ...
            {16,  72,   0,   1,   700,  400,  0,   0,     3, 1,  140,  25,    0,  80,  5,     1,     1,   5,  10,    0, 300,  0,  1000, 707}, // 16: Kalimba       Dkay 20→140(2.0s)
            {17,  60,   0,   1,   600,  350,  0,   0,     3, 4,  100,  20,    0,  30, 12,   800,    10,   5,  20,    0, 300,  0,  1000, 707}, // 17: Steel Pan     Dkay 60→100(707ms)
            {18,  79,   0,   1,   900,  480,  0,   0,     3, 2,    3,   5,    0,  50,  1,    20,     1,   5,   0,    0, 300,  0,   800, 707}, // 18: Claves
            {19,  67,   0,   1,   800,  450,  0,   0,     3, 4,   55,  25,    0,  20,  4,  1700,    20,   5,  30,    0, 300,  0,  1000, 707}, // 19: Cowbell       Dkay 15→55(~220ms)
            {20,  84,   0,   1,   900,  500,  0,   0,     3, 1,  165,  30,    0,  10, 15,  1990,    80,   5,   0,    0, 300,  0,  1500, 707}, // 20: Triangle      Dkay 100→165(~4s)
            {21,  36,   0,   1,   300,  150,  0,   0,     3, 5,   50,  -5,    0,  50,  6,    20,     1,   5, 100,   50, 200,  0,   300, 707}, // 21: Kick Drum     Dkay 20→50(~188ms)
            ...
            {24,  72,   0,   1,   100,   50,  0,   0,     3, 7,   90,  -5,    0,  10, 12,     1,     1,   5,   0,  350, 800,  0,   600, 707}, // 24: Flute         NzMix 0→350(breath noise enabled)
            {25,  60,   0,   1,   100,   50,  0,   0,     3, 8,   90,  -5,    0,  10, 12,     1,     1,   5,   0,  250, 800,  0,   600, 707}, // 25: Clarinet      NzMix 0→250(reed breath noise enabled)
            {26,  36,   0,   1,   600,  250,  0,   0,     3, 0,   85,  -8,    0,  20, 10,     0,     1,   5,  60,    0, 300,  0,   500, 707}, // 26: Pluck Bass    Dkay 60→85(~490ms)
