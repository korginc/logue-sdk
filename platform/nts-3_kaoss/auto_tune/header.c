...
const __unit_header genericfx_unit_header_t unit_header = {
  .common = {
    ...
    .params = {
      ...
      {0, 100, 100, 100, k_unit_param_type_percent, 0, 0, 0, {"MIX"}},
  ...
  .default_mappings = {
    ...
    {k_genericfx_param_assign_x, k_genericfx_curve_linear, k_genericfx_curve_unipolar, 0, 11, 0},

    // SCALE mapped to Y axis
    {k_genericfx_param_assign_y, k_genericfx_curve_linear, k_genericfx_curve_unipolar, 0, 8, 0},
